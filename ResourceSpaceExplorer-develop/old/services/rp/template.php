...
class MEXP_RP_Template extends MEXP_Template {

	public function item( $id, $tab ) {
		?>
		<div id="mexp-item-rp-<?php echo esc_attr( $tab ); ?>-{{ data.id }}" class="mexp-item-area" data-id="{{ data.id }}">
